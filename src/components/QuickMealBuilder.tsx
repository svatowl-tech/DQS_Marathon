...
const PRESET_COMBOS: MealPresetCombo[] = [
  {
    ...
    category: 'breakfast',
    servings: { whole_grains: 1, meat: 1, dairy: 1, oils: 1 },
    description: 'Классический DQS-завтрак: овсянка на молоке, 2 вареных яйца, кофе',
  },
  {
    id: 'b2',
    title: '🫐 Творог 150г + Орехи + Ягоды',
    category: 'breakfast',
    servings: { dairy: 1, nuts: 1, fruits: 0.5 },
  ...
  },
  {
    ...
    category: 'breakfast',
    servings: { meat: 1, vegetables: 1, oils: 1, nuts: 0.5 },
  ...
  },
  {
    ...
    category: 'main',
    servings: { meat: 1, whole_grains: 1, vegetables: 1, oils: 1 },
  ...
  },
  {
    ...
    category: 'main',
    servings: { meat: 1, vegetables: 1.5, oils: 1 },
  ...
  },
  {
    ...
    category: 'main',
    servings: { vegetables: 1, meat: 1, oils: 1, other_grains: 1 },
  ...
  },
  {
    ...
    category: 'main',
    servings: { potatoes: 1, meat: 1, greens: 0.5, oils: 1 },
    description: 'Картофель отварной/запеченный, бедро, свежая зелень',
  },
  {
    id: 's1',
  ...
  },
  {
    ...
    category: 'fastfood',
    servings: { processed_meat: 2 },
    description: '2 порции переработанного мяса / фастфуда (-4б)',
  },
  {
    id: 'f2',
